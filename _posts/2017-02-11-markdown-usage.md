...
Рассмотрим базовый синтаксис **Markdown** поддерживают базовый синтаксис, описанный в оригинальном дизайнерском документе Джона Грубера.

> Использование Markdown не означает, что вы не можете использовать HTML
>    Добавление HTML-тегов допускается в любой файл Markdown

## Заголовки

Чтобы создать заголовок, добавьте знаки ( `#` ) перед словом или фразой. Количество этих знаков должно соответствовать уровню заголовка. Например, чтобы создать заголовок третьего уровня (`<h3>`), используйте три цифровых знака (например, `### Мой Заголовок`).

| Markdown                 | HTML                                  | Результат                           |
| -----------------        | ---------------------------------     | ---------------------------------   |
| # Заголовок уровня 1     | <h1>Заголовок уровня 1</h1>          | # Заголовок уровня 1                 |
| ## Заголовок уровня 2    | <h2>Заголовок уровня 2</h2>          | ## Заголовок уровня 2                |
| ### Заголовок уровня 3   | <h3>Заголовок уровня 3</h3>          | ### Заголовок уровня 3               |
| #### Заголовок уровня 4  | <h4>Заголовок уровня 4</h4>          | #### Заголовок уровня 4              |
| ##### Заголовок уровня 5 | <h5>Заголовок уровня 5</h5>          | ##### Заголовок уровня 5             |
